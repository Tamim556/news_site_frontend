...
<footer className="bg-gray-100 font-sans mt-4 ">
    <div className="container px-6 py-12 mx-auto">
        ...
        <hr className="mt-1 border-gray-200 md:my-1 dark:border-gray-700 h-2" />
        ...
        <p className="font-sans py-8 text-start md:text-center md:text-lg md:p-2">© 2024 You Company Inc. All rights reserved.</p>
    </div>
</footer>
    </div>
  )
